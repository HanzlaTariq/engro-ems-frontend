...
export default function ManageSafetyTalk() {
  ...
  const fetchRecords = async () => {
    try {
      ...
      const res = await API.get("/api/safety-talk", {
          ...
          <table className="min-w-full text-xs text-gray-700">
            <thead className="bg-gray-200 text-gray-800 uppercase text-[10px]">
              <tr>
                ...
                <th className="py-1 px-2 border">No. of Labours</th>
                <th className="py-1 px-2 border">HC Present</th>
              ...
              {records.length === 0 ? (
                ...
                records.map((rec) => (
                  <tr key={rec._id} className="text-center border-t hover:bg-gray-50 transition">
                    ...
                    <td className="py-1 px-2 border">{rec.noOfLabours}</td>
                    <td className="py-1 px-2 border">{rec.hcPresent}</td>
